...
using Orleans.Redis.Clustering;
	...
	class Program
	{
		static void Main(string[] args)
		{
		    var builder = new SiloHostBuilder()
		        ...
		        .UseRedisClustering(options => options.Configuration = "localhost")
		        .ConfigureEndpoints(EndpointOptions.DEFAULT_SILO_PORT, EndpointOptions.DEFAULT_GATEWAY_PORT, listenOnAnyHostAddress: true)
